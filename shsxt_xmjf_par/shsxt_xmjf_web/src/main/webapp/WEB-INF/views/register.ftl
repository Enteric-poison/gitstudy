...
<head>
    <meta charset="UTF-8">
    <title>注册</title>
    <link rel="stylesheet" href="${ctx}/statics/css/register.css">
...
<div class="login-content">
    <div class="login-content-center">
        <div class="whole-img">
            <img src="/statics/img/registerBackground.png"/>
        </div>
        <div class="login-box">
            <div class="box-title">
                用户注册
            ...
            <div class="box-input">
                ...
                <div class="login-text">
                    <div class="login-text-center" style="font-size: 16px">
                        <span style="color: #606060">已有账户？</span><a href="${ctx}/login" style="color: #ff5e5e;cursor:pointer;">立即登录</a>
                    </div>
                </div>
            </div>
        </div>
