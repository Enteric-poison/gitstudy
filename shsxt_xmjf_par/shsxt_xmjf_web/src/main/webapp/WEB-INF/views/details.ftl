...
<head>
    ...
    <link rel="stylesheet" href="/statics/css/details.css">
    <link rel="stylesheet" href="/statics/css/page.css">
    <script type="text/javascript" src="${ctx}/statics/js/assets/radialIndicator.js"></script>
    <script type="text/javascript" src="${ctx}/statics/js/assets/require.js"></script>
    <script type="text/javascript" src="${ctx}/statics/js/details.js"></script>
    ...
    <#if item??>
        <div class="invest_item">
            ...
            <div class="invest_detail">
                ...
                <div class="radialIndicator" >
                    <p  id='rate'  data-val="${item.itemScale}" style="
    margin-top: -12px;"></p>
                    <p class="details_text">投资进度</p>
                </div>
            </div>
    ...
    <div class="item_introduce">
        ...
        <div id="contents">
            <div class="tab_content" >
                ...
                <div class="type_box">
                    <img src="/statics/img/cheshangbao.png" alt="">
                </div>
            ...
            <div class="tab_content" style="display: none">
                <div class="all_security_img">
                    <img src="/statics/img/fengxianbaozhang.png" alt="">
                </div>
                <div class="security_bottom">
                    <ul class="clear">
                        <li style="background-image: url(/statics/img/gongsi.png)">项目公司
                            本息担保</li>
